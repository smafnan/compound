...
const EN: Dict = {
  ...
  save: 'save', everyDayCounts: 'every second counts !',
...
const AR: Dict = {
  ...
  save: 'حفظ', everyDayCounts: '! كل ثانية لها قيمة',
...
const FR: Dict = {
  ...
  save: 'enregistrer', everyDayCounts: 'chaque seconde compte !',
...
const DE: Dict = {
  ...
  save: 'speichern', everyDayCounts: 'jede Sekunde zählt !',
...
const ES: Dict = {
  ...
  save: 'guardar', everyDayCounts: '¡ cada segundo cuenta !',
...
const HI: Dict = {
  ...
  save: 'सहेजें', everyDayCounts: 'हर सेकंड मायने रखता है !',
